...
with open("T2.1_L100_N1000000_o_samples.txt") as infile:
    i=0
    for line in infile:
...
with open("T2.1_L100_N1000000_u_samples.txt") as infile:
    i=0
    for line in infile:
...
with open("T2.4_L100_N1000000_o_samples.txt") as infile:
    i=0
    for line in infile:
...
with open("T2.4_L100_N1000000_u_samples.txt") as infile:
    i=0
    for line in infile:
...
plt.plot(n_MC_cycles, mean_eps_T10_u, '-', linewidth=2.0, color='#377eb8', label='$T=2.1$ $J/k_{B}$, unordered')
plt.plot(n_MC_cycles, mean_eps_T10_o, '-', linewidth=2.0, color='#4daf4a', label='$T=2.1$ $J/k_{B}$, ordered')
...
plt.savefig("fig_burn_in_L100.pdf")
plt.show()
